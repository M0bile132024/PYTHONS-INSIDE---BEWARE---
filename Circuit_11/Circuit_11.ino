...
// You can make timeDelay
 //shorter, but note that relays, being
// mechanical devices, will wear quickly if you try to drive
// them too fast.
...
void setup()
{
  ...
  /*
  In Morse code, the timing is based on the length of one "dit" (or "dot"). Here are the basic timing rules:
  ...
  */
  ...
  morse_light_outputter(3,1);
  morse_light_outputter(3,3); 
  ...
  morse_light_outputter(3,1);
  morse_light_outputter(1,1);  
  morse_light_outputter(1,1); 
  morse_light_outputter(1,3); 
...
void morse_light_outputter(int how_long, int pause)
{
  digitalWrite(relayPin, HIGH);  // turn the relay on
  
  delay(timeDelay * how_long);              // wait for one second
